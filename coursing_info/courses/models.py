...
class course(models.Model):
    courses_title=models.CharField(max_length=2000)
    courses_online=models.CharField(max_length=100)
    course_video=models.CharField(max_length=8000)
    course_mashaghel_link=models.CharField(max_length=8000,blank=True,null=True)
    courses_date=models.CharField(max_length=100)
    courses_teacher_name=models.CharField(max_length=8000,blank=True,null=True)
    course_teacher_rezume=models.CharField(max_length=8000,blank=True,null=True)
    course_id=models.CharField(max_length=1000)
    course_time=models.CharField(max_length=1000)
    ...
    course_image=models.ImageField(upload_to='',null=True)
